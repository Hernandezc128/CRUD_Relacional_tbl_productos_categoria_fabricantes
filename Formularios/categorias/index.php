        ...
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?php echo $resultado['id_categoria'] ?></th>
                            <th scope="row"><?php echo $resultado['nom_categoria'] ?></th>
                            <th scope="row"><?php echo $resultado['descripcion'] ?></th>
                            <th scope="row"><?php echo $resultado['fech_creacion'] ?></th>
                            <th scope="row"><?php echo $resultado['num_producto'] ?></th>
                            <th scope="row"><?php echo $resultado['prom_costos'] ?></th>
                            <th scope="row"><?php echo $resultado['img_producto'] ?></th>
                            <th scope="row"><?php echo $resultado['nom_fabricante'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?Id=<?php echo $resultado['id_categoria'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['id_categoria'] ?>" class="btn btn-outline-danger">
