                ...
                <tbody>
                    <?php
                        ...
                        while ($resultado = $sql->fetch_assoc()) {
                            ?>
                            <tr>
                                <th scope="row"><?php echo $resultado['id_prducto'] ?></th>
                                ...
                                <th scope="row"><?php echo $resultado['stock'] ?></th>
                                <th scope="row"><?php echo $resultado['fech_vencimiento'] ?></th>
                                <th scope="row"><?php echo $resultado['id_categoria'] ?></th>
                                <th scope="row"><?php echo $resultado['id_fabricante'] ?></th>
                                <th scope="row">
                                    <a href="<?php echo base_url; ?>Formularios/productos/actualizar.php?Id=<?php echo $resultado['id_prducto'] ?>" class="btn btn-outline-warning">
                                        <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                    </a>
                                    <a href="<?php echo base_url; ?>CRUDP/eliminarDatos.php?Id=<?php echo $resultado['id_prducto'] ?>" class="btn btn-outline-danger">
