                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom_fabricante" name="nom_fabricante" placeholder="Nombre del fabricante" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="fech_registro" name="fech_registro" placeholder="Fecha de Registro" required>
                            </div>
                            <div class="mb-3">
